...
export default function PostAds({navigation, route}) {
  // const {item, otherParam} = route.params;

  // console.log('user data is', item, otherParam);
      ...
      <TouchableOpacity onPress={() => navigation.navigate('Ad')}>
        <View style={styles.listelem}>
          <FontAwesome
            ...
            onPress={() => navigation.navigate('Profile')}
          />
          <Text style={styles.listtxt}>Post an ad </Text>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('MyAds')}>
        <View style={styles.listelem}>
          <FontAwesome
            ...
            solid
          />
          <Text style={styles.listtxt}>My Ads </Text>
          <Text style={styles.amount}></Text>
        </View>
      </TouchableOpacity>
